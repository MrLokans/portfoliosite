...
class Command(BaseCommand):
    ...
    EXPORTED_FIELDS = (
        ...
        'longitude', 'latitude', 'author_url', 'status',
        'user_phones', 'user_name', 'last_updated',
        'image_links', 'has_balcony', 'has_conditioner',
        'has_balcony', 'has_conditioner', 'has_fridge',
        'has_furniture',
        'has_kitchen_furniture', 'has_oven', 'has_tv',
        'has_washing_machine',
    )
